...
function setup(){
    ...
    fixSprite1=createSprite(100,580,190,30);
    fixSprite1.shapeColor="red";

    fixSprite2=createSprite(300,580,190,30);
    fixSprite2.shapeColor="green";

    fixSprite3=createSprite(500,580,190,30);
    fixSprite3.shapeColor="blue";

    fixSprite4=createSprite(700,580,190,30);
